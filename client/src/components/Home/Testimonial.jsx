  ...
  return (
    ...
    <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
      <div className="flex items-center gap-2 text-sm text-blue-800 bg-blue-400/10 border border-indigo-200 rounded-full px-6 py-1.5">
        ...
        <Title title="Don't just take our words" description="Hear what our user say about us. We're always looking for ways to improve. If you have a positive experince with us, leave a review."/>
    </div>
